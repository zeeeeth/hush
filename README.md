...
1. **GNN Prediction** — A two-layer GCN model takes current ridership data and time-of-day features, then predicts next-hour tap-ins for every station complex.
