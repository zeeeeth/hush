...
class GNNPredictor:
    ...
    def __init__(
        ...
        model_config_path="models/best_model_config.json",
        ...
        self.node_to_cmplx = dict(
            zip(self.ComplexNodes["node_id"], self.ComplexNodes["complex_id"])
        )
        self.ComplexNodes_dict = dict(
            zip(self.ComplexNodes["complex_id"], self.ComplexNodes["node_id"])
        )
